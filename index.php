...
<body>
    <main class="main">
        <h1 class="main__title">Rejestracja</h1>

        <section>
            <form class="form js-form" method="POST">
                <div class="form__dignity">
                    <div class="form__label">
                        <span class="form__name">Imię</span>
                        <input class="form__input js-name" placeholder="Imię">
                    </div>
                    <div class="form__label">
                        <span class="form__name">Nazwisko</span>
                        <input class="form__input js-name" placeholder="Nazwisko">
                    </div>
                </div>
                ...
                <button class="form__button">Zarejestruj się</button>
            </form>
        </section>
    </main>
</body>
